...
int main(int argc,char *argv[]){
  ...
  int d=read_data(true,bf,trueNN,avg,0,true,traversals,GV,0,input,query,L,n1,n2,inputPoints,queryPoints,inputVector,queryVector);
  ...
  findNN(max,true,trueNN,avg,true,L,n2,queryPoints,queryVector,w,d,k,M,mArray,gs,htable,0,F,um,0,output);
  for(int i=0;i<L;i++){
    delete gs[i];
	}
  delete[] mArray;
